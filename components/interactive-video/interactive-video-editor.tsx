...
export function InteractiveVideoEditor() {
  ...
  const handleSaveToLibrary = useCallback(() => {
    ...
    try {
      saveProject(nanoid(10), title, videoSource.src, videoSource.type, interactions)
    ...
    <div className="mx-auto min-h-screen max-w-4xl p-4 md:p-8">
      ...
      <div className="mb-6 flex rounded-lg border border-border bg-card p-1">
        <button
          ...
          className={`flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-colors ${activeTab === "upload"
        ...
        <button
          ...
          className={`flex flex-1 items-center justify-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium transition-colors ${activeTab === "interactions"
              ? "bg-primary text-primary-foreground shadow-sm"
              : "text-muted-foreground hover:text-foreground"
            }`}
        >
      ...
      <div className="mt-6 flex items-center justify-between">
        <span
          className={`text-sm font-medium transition-opacity ${saveMessage ? "opacity-100" : "opacity-0"
